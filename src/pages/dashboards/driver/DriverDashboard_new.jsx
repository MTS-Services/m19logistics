...
const DriverDashboard = () => {
  ...
  const navigationSections = [
    {
      title: 'Main',
      items: [{ name: 'Dashboard', href: '/driver/dashboard', icon: Home }],
    },
    {
      title: 'Deliveries',
      items: [
        { name: 'Assigned Deliveries', href: '/driver/deliveries', icon: Package },
            ...
            <div className="flex items-center space-x-3">
              {user?.profilePhoto ? (
                <img
                  ...
                  alt={user.name}
                  className="h-12 w-12 rounded-full object-cover ring-2 ring-teal-500"
                />
              ) : (
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">{user?.username || 'Driver'}</p>
              </div>
            </div>
          </div>
