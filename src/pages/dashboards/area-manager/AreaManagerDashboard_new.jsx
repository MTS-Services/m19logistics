...
const AreaManagerDashboard = () => {
  ...
  const navigationSections = [
    {
      title: 'Main',
      items: [{ name: 'Dashboard', href: '/area-manager/dashboard', icon: Home }],
    },
    {
      title: 'Reports & Analytics',
      items: [
        { name: 'Analytics', href: '/area-manager/analytics', icon: BarChart3 },
        { name: 'Store Performance', href: '/area-manager/performance', icon: TrendingUp },
      ],
    },
    {
      title: 'Data',
      items: [
        { name: 'Invoices', href: '/area-manager/invoices', icon: FileText },
        { name: 'All Deliveries', href: '/area-manager/deliveries', icon: Package },
      ],
    },
  ];
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between border-b border-gray-700 px-6">
            <div className="flex items-center space-x-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-linear-to-br from-teal-500 to-blue-600">
                <Truck className="h-6 w-6 text-white" />
              </div>
              <span className="text-lg font-bold text-white">M19 Analytics</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="border-b border-gray-700 p-6">
            ...
            {/* Read-Only Badge */}
            <div className="mt-3 flex items-center gap-2 rounded-lg bg-blue-900/50 px-3 py-2">
              <Eye className="h-4 w-4 text-blue-400" />
              <span className="text-xs font-medium text-blue-300">Read-Only Access</span>
            </div>
          </div>
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 shadow-sm sm:px-6">
          ...
          <div className="flex items-center space-x-4">
            <span className="hidden rounded-full bg-blue-100 px-3 py-1 text-xs font-semibold text-blue-800 sm:inline">
              Read-Only
            </span>
          </div>
        </header>
