...
const AreaManagerDashboardLayout = () => {
  ...
  const navigationSections = [
    {
      title: 'Main',
      items: [{ name: 'Dashboard', href: '/area-manager/dashboard', icon: LayoutDashboard }],
    },
    {
    ...
    {
      title: 'Account',
      items: [{ name: 'Profile', href: '/area-manager/profile', icon: User }],
    },
  ];
...
export default AreaManagerDashboardLayout;
