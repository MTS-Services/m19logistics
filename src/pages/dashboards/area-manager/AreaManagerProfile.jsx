    ...
    const fetchProfile = async () => {
      try {
        ...
        if (response.data && response.data.success && response.data.data) {
          ...
          const managerProfile = userData.managerProfile;
          ...
          setProfileData({
            ...
            address: managerProfile?.officeAddress || '',
            role: userData.role,
            assignedStores: managerProfile?.assignedStoreCount
              ? `${managerProfile.assignedStoreCount} Topps Tiles Stores`
              : 'No stores assigned',
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600">Assigned Stores</p>
                  <p className="text-sm font-semibold text-gray-900">{profileData.assignedStores}</p>
                  {profileData.accessScope && (
                    <p className="text-xs text-gray-500 mt-0.5">{profileData.accessScope}</p>
                  )}
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleProfileUpdate}>
                <div className="mb-6 flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-blue-600">{profileData.assignedStores}</p>
                    {profileData.accessScope && (
                      <p className="text-xs text-gray-500">{profileData.accessScope}</p>
                    )}
                  </div>
                </div>
...
export default AreaManagerProfile;
