      ...
      try {
        ...
        if (res.data && res.data.success && Array.isArray(res.data.data)) {
          const mapped = res.data.data.map((u) => ({
            ...
            pricingTierData: u.customerProfile?.pricingTier || null,
            customBasePrice: u.customerProfile?.customBasePrice || null,
                ...
                onSuccess={async (newUser) => {
                  ...
                  try {
                    ...
                    const mapped = {
                      ...
                      pricingTierId: newUser.customerProfile?.pricingTier?.id || null, pricingTierData: newUser.customerProfile?.pricingTier || null, ccEmail: newUser.customerProfile?.ccEmail || null,
                ...
                onSuccess={async (updatedUser) => {
                  ...
                  try {
                    ...
                    const mapped = {
                      ...
                      pricingTierData: updatedUser.customerProfile?.pricingTier || null,
