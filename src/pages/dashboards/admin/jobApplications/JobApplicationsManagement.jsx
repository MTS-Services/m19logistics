  ...
  return (
    <div className="p-2 sm:p-6">
      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Jobs Application</h1>
                        ...
                        >
                          ...
                          <td className="px-4 py-3">
                            {app.cvUrl ? (
                              <a
                                ...
                                className="flex items-center gap-1 rounded-md border border-teal-200 bg-teal-50 px-2.5 py-1 text-xs font-medium text-teal-700 transition-all hover:bg-teal-100"
                              >
                          ...
                          <td className="px-4 py-3">
                            <button
                              ...
                              className="flex items-center gap-1 rounded-md border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-600 transition-all hover:border-teal-300 hover:bg-teal-50 hover:text-teal-700"
                            >
