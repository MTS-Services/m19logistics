                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`mt-1 block w-full rounded-lg border px-3 py-2 shadow-sm focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none ${errors.invoiceNumber ? 'border-red-500' : 'border-gray-300'
                                            }`}
                            ...
                            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
                                <div className="mb-4 flex items-center justify-between">
                                    <h3 className="text-sm font-medium text-gray-700">
                                        Invoice Items
                                        {errors.items && <span className="text-red-500 text-xs ml-2">{errors.items}</span>}
                                    </h3>
                                    <button
                                        type="button"
                                        onClick={addItem}
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="mt-1 block w-full rounded-lg border border-gray-300 px-2 py-1.5 text-sm shadow-sm focus:border-teal-500 focus:ring-1 focus:ring-teal-500 focus:outline-none bg-gray-50"
                                                            readOnly
                                                        />
                                                    </div>
                                                </div>
