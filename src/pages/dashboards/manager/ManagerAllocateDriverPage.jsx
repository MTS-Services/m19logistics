...
const ManagerAllocateDriverPage = () => {
      ...
      try {
        ...
        if (response.data.success) {
          const mappedDrivers = response.data.data.map((driver) => ({
            ...
            rating: 4.5,
            currentDeliveries: driver.performance?.pending || 0,
            totalDeliveries: driver.performance?.totalDeliveries || 0,
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1 flex flex-col gap-1 text-sm text-gray-600 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            <span>{driver.totalDeliveries} total</span>
                          </div>
                        </div>
...
export default ManagerAllocateDriverPage;
