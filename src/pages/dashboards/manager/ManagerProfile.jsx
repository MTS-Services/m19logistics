...
const ManagerProfile = () => {
  ...
  const [profileData, setProfileData] = useState({
    name: user?.name || 'Area Manager',
    email: user?.email || 'manager@m19logistics.com',
    phone: user?.phone || '07700900000',
    address: 'M19 Logistics Head Office, Manchester',
    role: 'Manager',
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">{profileData.department}</p>
              </div>
            </div>
          </div>
        </div>
